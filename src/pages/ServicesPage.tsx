      ...
      <div className="container-main px-4 sm:px-6 lg:px-8 py-12 md:py-20 flex flex-col md:flex-row">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-lg text-muted-foreground leading-relaxed">
            With over 400 brands currently managed, we know what it takes to be
            successful on Amazon. From SEO to PPC, design, and troubleshooting,
            our Amazon experts can provide the service you need to grow.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-card rounded-xl p-6 border border-border flex flex-col gap-1"
              >
                ...
                <Link
                  to="/services"
                  className="inline-flex gap-2 items-center mt-4 text-sm font-semibold hover:underline transition-colors"
                >
                  <ArrowIcon />
                  Learn more
                </Link>
